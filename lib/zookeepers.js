...
function filterbyQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            //since our form data will come in as strings, and our JSON is storing
            //age as a number, we have to convert the query string to a number
